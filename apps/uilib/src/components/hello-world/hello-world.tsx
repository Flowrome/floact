      ...
      <Host>
        <article class={'markdown-body'}>
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1000" height="171" viewBox="0 0 1000 171">
            <g transform="matrix(1,0,0,1,-0.6060416007943559,0.575130741465415)">
              <svg viewBox="0 0 396 68" data-background-color="#ffffff" preserveAspectRatio="xMidYMid meet" height="171" width="1000" xmlns="http://www.w3.org/2000/svg">
                <defs></defs>
                <g id="tight-bounds" transform="matrix(1,0,0,1,0.2399924739145547,-0.2287069615184123)">
                  <svg viewBox="0 0 395.5199999999999 68.45741392303685" height="68.45741392303685" width="395.5199999999999">
                    <g>
                      <svg viewBox="0 0 522.8348952406632 90.49333747192985" height="68.45741392303685" width="395.5199999999999">
                        <g>
                          <rect
                            width="5.905052505313247"
                            height="78.57598043872346"
                            x="105.95159010363992"
                            y="5.958678516603193"
                            fill="#8b3c7f"
                            opacity="1"
                            stroke-width="0"
                        ...
                        <g transform="matrix(1,0,0,1,127.31489524066323,12.506676886496813)">
                          <svg viewBox="0 0 395.52 65.47998369893622" height="65.47998369893622" width="395.52">
                            <g>
                              <svg viewBox="0 0 395.52 65.47998369893622" height="65.47998369893622" width="395.52">
                                <g>
                                  <svg viewBox="0 0 395.52 65.47998369893622" height="65.47998369893622" width="395.52">
                        ...
                        <g>
                          <svg viewBox="0 0 90.49333747192985 90.49333747192985" height="90.49333747192985" width="90.49333747192985">
                            <g>
                              <svg
                                ...
                                height="90.49333747192985"
                                width="90.49333747192985"
                                class="icon-icon-0"
                  ...
                  <rect width="395.5199999999999" height="68.45741392303685" fill="none" stroke="none" visibility="hidden"></rect>
                </g>
              </svg>
            </g>
          </svg>
          ...
          <ul>
            ...
            <li>
              <a href="#how-to-start-local-environment">How to start local environment</a>
            </li>
            <li>
              <a href="#how-to-build-the-web-app-for-production">How to build the web app for production</a>
            </li>
            <li>
              <a href="#how-to-use-environments">How to use environments</a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <a href="https://nodejs.org/en/">Nodejs 16+ / npm</a>
            </li>
          </ul>
          ...
          <ul>
            <li>
              Run <code>rm -rf .git</code> to remove the git project
            </li>
            <li>
              Replace the following placeholders with your application name in the project folder (use CMD/CTRL + SHIFT + F as a find shortcuts in <strong>VSCode</strong>):
              <ul>
                <li>
                  <strong>FLOACT</strong> -&gt; <strong>APPLICATION NAME IN UPPERCASE</strong>
                </li>
                <li>
                  <strong>floact</strong> -&gt; <strong>application name in lowercase (use only alphacharacter)</strong>
                </li>
              </ul>
            </li>
            <li>
          ...
          <ul>
            <li>
              Run <code>npm start</code> in the project root folder to create a development local web server
              <ul>
                <li>
                  Will build the UI components from <strong>uilib</strong> app
                </li>
                <li>
                  Will start the flask apis server from <strong>server</strong> app
                </li>
                <li>
                  Will start the NextJS web app from <strong>client</strong> app
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              Run <code>npm build</code> in the project root folder to build the web application
              <ul>
                <li>
                  Will build the UI components from <strong>uilib</strong> app
                </li>
                <li>
                  Will build the NextJS web app from <strong>client</strong> app
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              Create the file <code>envs/.env.[ENVIRONMENT_NAME]</code>
            </li>
            <li>
              Write the following scripts inside the <code>package.json</code> in the project root folder:
              <ul>
                <li>
                  <code>
            ...
            <li>
              Run <code>yarn start:[ENVIRONMENT_NAME]</code> to launch all the apps
            </li>
            <li>
              <strong>SIDE NOTES</strong>:
              <ul>
                <li>Please try to mantain all the environemnt variables available in each environment</li>
                <li>Three environments should be enough but eventually you can add/remove how many you like following the procedure above</li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              The UI library is written using <strong>Web Components</strong> using <strong>StencilJS</strong>
            </li>
            <li>
              All the <strong>css variables</strong> that define the global theme should be written inside the UI library
            </li>
            <li>
              If you choose to remove the UI library please remove all the references inside the <strong>client</strong> app
              <ul>
                <li>
          ...
          <ul>
            <li>
              It is served with <code>flask run</code> in local environment
            </li>
            <li>
              It is server using{' '}
              <strong>
                <a href="https://flask.palletsprojects.com/en/2.2.x/deploying/">wsgi</a>
              </strong>{' '}
              and{' '}
              <strong>
